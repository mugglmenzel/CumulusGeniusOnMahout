 ...
 * {@code <key, candidate, key, fitness>} , where :
 * </p>
...
public class EvalMapper extends
	...
	private static Logger log = Logger.getLogger(EvalMapper.class.getName());
	...
	public void setup(Context context) throws IOException, InterruptedException {
		...
		Preconditions.checkArgument(evlstr != null,
				"'MAHOUT_GA_EVALUATOR' job parameter not found");
		...
		while ((line = br.readLine()) != null)
			population.add(StringUtils.fromString(line));
	...
	public void map(LongWritable key, Text value, Context context)
		...
		double fitness = evaluator.getFitness(candidate, population);
